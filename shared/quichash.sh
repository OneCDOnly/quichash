...
Init()
	...
	readonly r_linkname_pathfile=/usr/bin/qhash
...
StartQPKG()
    ...
    if IsNotQPKGEnabled; then
        ...
        ln -sf $(/sbin/getcfg $r_qpkg_name Install_Path -f /etc/config/qpkg.conf)/quichash-launch.sh "$r_linkname_pathfile"
